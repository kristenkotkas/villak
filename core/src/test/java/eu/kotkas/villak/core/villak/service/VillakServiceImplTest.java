 ...
 */
class VillakServiceImplTest {

  private final VillakService villakService = new VillakServiceImpl(
    new VillakDao()
  );
  ...
  void reduce_questionActions() {
    ...
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.QUESTION_OPEN, 1L, null));
    ...
    Game gameSt3 = villakService.reduce(gameSt2, getSingleMessage(Action.QUESTION_CLOSE, 1L, null));
    ...
    Game gameSt4 = villakService.reduce(gameSt3, getSingleMessage(Action.QUESTION_ANSWERED, 2L, null));
    ...
    Game gameSt5 = villakService.reduce(gameSt4, getSingleMessage(Action.QUESTION_SILVER, 3L, null));
  ...
  void reduce_teamScore() {
    ...
    // score is increased
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.TEAM_SCORE, 0, 100L));
    assertTeam(gameSt2, 0, Team::getScore, 100);
    assertTeam(gameSt2, 1, Team::getScore, 0);
    assertTeam(gameSt2, 2, Team::getScore, 0);

    // score is reduced
    Game gameSt3 = villakService.reduce(gameSt2, getSingleMessage(Action.TEAM_SCORE, 1, -150L));
  ...
  void reduce_categoryState() {
    ...
    // show category
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.CATEGORY_SHOW, 1, null));
    ...
    // hide category
    Game gameSt3 = villakService.reduce(gameSt2, getSingleMessage(Action.CATEGORY_HIDE, 1, null));
  ...
  void reduce_round() {
    ...
    Game gameSt1 = villakService.reduce(game, getSingleMessage(Action.ROUND_ACTIVE, 0, null));
    ...
    Game gameSt2 = villakService.reduce(gameSt1, getSingleMessage(Action.ROUND_ACTIVE, 1, null));
    ...
    // second round to active
    Game gameSt3 = villakService.reduce(gameSt2, getSingleMessage(Action.ROUND_ACTIVE, 2, null));
  ...
  void reduce_team_pressButton_Reset() {
    // first pressed
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.PRESS_BUTTON, 0, 123L));
    ...
    // second pressed
    Game gameSt3 = villakService.reduce(gameSt2, getSingleMessage(Action.PRESS_BUTTON, 2, 64L));
    ...
    // reset button
    Game gameSt4 = villakService.reduce(gameSt3, getSingleMessage(Action.RESET_BUTTON, -1, null));
  ...
  void reduce_showQuickest_allZero() {
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.SHOW_QUICKEST, -1, null));
  ...
  void reduce_showQuickest_onePressedOthersZero() {
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.PRESS_BUTTON, 1, 123L));
    Game gameSt3 = villakService.reduce(gameSt2, getSingleMessage(Action.SHOW_QUICKEST, -1, null));
  ...
  void reduce_showQuickest_quickestUniqueAllPressed() {
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.PRESS_BUTTON, 2, 100L));
    Game gameSt3 = villakService.reduce(gameSt2, getSingleMessage(Action.PRESS_BUTTON, 0, 101L));
    Game gameSt4 = villakService.reduce(gameSt3, getSingleMessage(Action.PRESS_BUTTON, 1, 102L));
    Game gameSt5 = villakService.reduce(gameSt4, getSingleMessage(Action.SHOW_QUICKEST, -1, null));
    ...
    // reset button
    Game gameSt6 = villakService.reduce(gameSt5, getSingleMessage(Action.RESET_BUTTON, -1, null));
  ...
  void reduce_closeAllButtons() {
    ...
    Game gameSt5 = villakService.reduce(gameSt4, getSingleMessage(Action.CLOSE_BUTTON, -1, null));
  ...
  void reduce_toggleWinner() {
    ...
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.TOGGLE_WINNER, 1, null));
    assertTeam(gameSt2, 0, Team::isWinner, false);
    assertTeam(gameSt2, 1, Team::isWinner, true);
    assertTeam(gameSt2, 2, Team::isWinner, false);

    Game gameSt3 = villakService.reduce(gameSt2, getSingleMessage(Action.TOGGLE_WINNER, 2, null));
    assertTeam(gameSt3, 0, Team::isWinner, false);
    assertTeam(gameSt3, 1, Team::isWinner, true);
    assertTeam(gameSt3, 2, Team::isWinner, true);

    Game gameSt4 = villakService.reduce(gameSt3, getSingleMessage(Action.TOGGLE_WINNER, 2, null));
  ...
  void reducer_adminDeviceId() {
    ...
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.SET_ADMIN_DEVICE_ID, -1, 123L));
  ...
  void reducer_clientDeviceId() {
    ...
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.SET_CLIENT_DEVICE_ID, -1, 123L));
  ...
  void reducer_teamDeviceId() {
    ...
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.SET_TEAM_DEVICE_ID, 1, 123L));
  ...
  void reducer_syncButton() {
    ...
    Game gameSt2 = villakService.reduce(game, getSingleMessage(Action.SYNC_BUTTON, 1, 123L));
